                    ...
                    <tbody>
                        ${purchase.purchase_items.map((item: any, index: number) => `
                            <tr>
                                ...
                                <td class="amount-cell">₹${Number(item.item_price).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                            </tr>
                        `).join('')}
                    </tbody>
                </table>
                ...
                <div class="totals-container">
                    ...
                    <div class="totals-right">
                        <div class="total-row">
                            ...
                            <span class="amount">₹${subtotal.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                        </div>
                        ${couponDiscount > 0 ? `
                            <div class="total-row">
                                <span class="label">Coupon Discount (${purchase.coupon_code}):</span>
                                <span class="amount" style="color: #dc2626;">-₹${couponDiscount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                            </div>
                        ` : ''}
                        <div class="total-row">
                            <span class="label">GST (18%):</span>
                            <span class="amount">₹${gstAmount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                        </div>
                        <div class="total-row final">
                            <span class="label">Total Amount:</span>
                            <span class="amount">₹${total.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                        </div>
                    </div>
                </div>
            </div>
